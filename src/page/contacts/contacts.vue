<template>
    <div class="contacts">
      ...
      <head-top>
        ...
        <span slot="head_btn" class="head_btn">
      ...
      <div class="main_wrapper">
        <div class="container">
          ...
          <div class="tab">
            ...
            <span class="tab_item" :class="{active:tabActive==0}" @click="handleChangeTab(1)">群</span>
            <span class="tab_item" :class="{active:tabActive==0}" @click="handleChangeTab(2)">多人聊天</span>
            <span class="tab_item" :class="{active:tabActive==0}" @click="handleChangeTab(3)">设备</span>
            <span class="tab_item" :class="{active:tabActive==0}" @click="handleChangeTab(4)">通讯录</span>
            <span class="tab_item" :class="{active:tabActive==0}" @click="handleChangeTab(5)">公众号</span>
          </div>
          <div class="group clearfix" v-for="(group,index) in data" :key="index">
            ...
            <div class="group_list" :class="{hide:group.closed}">
              <router-link to="/profile" class="item" v-for="(item,index)">
