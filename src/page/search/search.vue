<template>
    <div class="search">
      <head-top :toggleBtn="false">
        <div class="search" slot="head_input">
          <div class="search_content">
            <i class="iconfont icon-search"></i>
            <input type="text" placeholder="搜索">
          </div>
        </div>
        <span slot="head_btn" class="head_btn" @clcik="returnBack">取消</span>
      </head-top>
      <!-- main start -->
            ...
            <router-link to="/chat" class="item">
              ...
              <div class="item_info">
                <div class="item_info_head">
                  <span class="name">万丈-Infinits</span>
                  <span class="close">x</span>
                </div>
              </div>
            </router-link>
            <router-link to="/chat" class="item">
              <div class="item_image" style="background-image:url(http://img.pingan.fusio.com.cn/materials/pic/700/20170928180518_0_KcXn.jpg20171012184532_0_xTaB.jpg)"></div>
              <div class="item_info last">
                <div class="item_info_head head">
