    ...
    <div class="container" :style="'height:'+wHeight+'px;'">
      ...
      <form class="login_form">
        <section class="input_container">
          <input v-model.lazy="userAccount" type="text" placeholder="邮箱" autocomplete="off">
        </section>
        <section class="input_container">
          <input v-if="!showPassword" v-model="passWord" type="password" placeholder="密码" autocomplete="off">
          <input v-else v-model="passWord" type="text" placeholder="密码" autocomplete="off">
      ...
      mothods:{
        ...
        async loginSubmit(){
          ...
          if(response.retCode != "10000"){
            ...
            this.$token.commit('SET_AUTH_INFO',[
              {
                email:email,
                token:token
              }
